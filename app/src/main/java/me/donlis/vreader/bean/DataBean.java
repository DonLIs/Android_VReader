...
public class DataBean extends BaseObservable {
    ...
    public void setCurPage(int curPage) {
        ...
        notifyPropertyChanged(me.donlis.vreader.BR.curPage);
    }
    ...
    public void setOffset(int offset) {
        this.offset = offset;
        notifyPropertyChanged(me.donlis.vreader.BR.offset);
    }
    ...
    public void setPageCount(int pageCount) {
        ...
        notifyPropertyChanged(me.donlis.vreader.BR.pageCount);
    }
    ...
    public void setSize(int size) {
        this.size = size;
        notifyPropertyChanged(me.donlis.vreader.BR.size);
    }
    ...
    public void setTotal(int total) {
        this.total = total;
        notifyPropertyChanged(me.donlis.vreader.BR.total);
    }
    ...
    public void setDatas(List<ArticlesBean> datas) {
        this.datas = datas;
        notifyPropertyChanged(me.donlis.vreader.BR.datas);
    }
