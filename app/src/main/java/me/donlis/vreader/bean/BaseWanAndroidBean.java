...
public class BaseWanAndroidBean<T> extends BaseObservable {
    ...
    public void setData(T data) {
        this.data = data;
        notifyPropertyChanged(me.donlis.vreader.BR.data);
    }
    ...
    public void setErrorCode(int errorCode) {
        ...
        notifyPropertyChanged(me.donlis.vreader.BR.errorCode);
    }
    ...
    public void setErrorMsg(String errorMsg) {
        ...
        notifyPropertyChanged(me.donlis.vreader.BR.errorMsg);
    }
